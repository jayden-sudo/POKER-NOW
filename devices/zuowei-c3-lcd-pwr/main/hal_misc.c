 ...
 * 整檔照抄 StickS3/poker/main/hal_misc.c,只改 device_class → 1(§11)。 */
...
/* zuowei-c3 device_class = 1(協定 §8.1);覆寫 poker_core 的弱符號(S3 §21.3 R12) */
uint8_t pk_board_device_class(void) { return 1; }
