 ...
 * StickS3 hal_misc.c 照抄,唯一改動:pk_board_device_class() 回 3(§12)。 */
...
/* Cardputer-Adv device_class = 3(協定 §8.1);覆寫 poker_core 的弱符號 */
uint8_t pk_board_device_class(void) { return 3; }
